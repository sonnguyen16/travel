        ...
        <div class="col-lg-8">
            ...
            <form>
              <div class="row">
                <div class="col-lg-6 mt-2">
                  ...
                  <input type="text" class="w-full border-[1.5px] border-green-600 rounded-lg p-2" />
                </div>
                <div class="col-lg-6 mt-2">
          ...
          >
            ...
            <form>
              ...
              <button class="bg-green-600 text-white px-4 py-2 rounded-xl mt-2 mr-auto">Thanh toán</button>
            </form>
          </div>
        </div>
        <div class="col-lg-4">
