                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <p>
                                    <label style="margin-right: 10px;">Giới tính <span style="color: red">*</span></label>
                                    <label class="radio-inline">
                                        <input type="radio" name="sex" value="1" required checked> Nam
                                    </label>
                                    <label class="radio-inline">
                                ...
                                <p>
                                    <label>
                                        <input name="super_user" id="super_user" type="checkbox" class="flat-red"> Super Admin
                                    </label>
                                </p>
                            </div>
                        </div>
